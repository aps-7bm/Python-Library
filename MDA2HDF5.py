...
#Set up logging
logger = logging.getLogger('MDA2HDF5')
...
def fstart_unpacking(input_filename,directory):
    ...
    try:
        ...
        logging.error("Could not open input file: " + directory+input_filename)
        raise IOError
    
def fread_file_header(data,output_hdf):
    '''Reads the file header and adds to the attributes of the hdf file.
    Inputs:
    data: xdrlib.Unpacker object for the MDA file.
    output_hdf: h5py.File object for the HDF5 file.
